...
def main(args):
    ...
    model_name=args['model_subtype']
    model_name=model_name[model_name.rfind('/') + 1:model_name.rfind('.')]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_subtype",type=str, required=True, help='the pretrained model to use for clip')
