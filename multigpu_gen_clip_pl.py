...
def main(args):
    ...
    model = torch.nn.DataParallel(model)  # Wrap the model for multi-GPU processing
    ...
    for i in range(0, N, batch_size):
        ...
        with torch.no_grad():
            logits_per_image, _ = model.module.forward_with_text_desc(batch_images, classifier_weights)
