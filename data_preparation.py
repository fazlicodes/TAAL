...
data_dict = {'eurosat':{'img_dir_name':'2750/','split_file':'split_zhou_EuroSAT.json','split_names':['train','val','test']},
             'fgvc_aircraft':{'img_dir_name':'data/','split_file':'fgvc_split.json','split_names':['train','val','test']},
             'food101':{'img_dir_name':'images/','split_file':'split_zhou_Food101.json','split_names':['train','val','test']},
            'cifar10':{'img_dir_name':'images/','split_file':'split_CIFAR10.json','split_names':['train','test']},
            'cifar100':{'img_dir_name':'images/','split_file':'split_CIFAR100.json','split_names':['train','test']},
            'resisc45':{'img_dir_name':'NWPU-RESISC45/','split_file':'split_resisc45.json','split_names':['train','test']},
            ...
            'ucm':{'img_dir_name':'Images/','split_file':'ucm_split.json','split_names':['train','val','test']},
            'whurs19':{'img_dir_name':'WHURS19/','split_file':'whurs19_split.json','split_names':['train','val','test']},
            'mlrsnet':{'img_dir_name':'Images/','split_file':'mlrsnet_split_new.json','split_names':['train','val','test']},
            'optimal31':{'img_dir_name':'Images/','split_file':'optimal31_split.json','split_names':['train','val','test']},
            ...
            # 'oxford_flowers':{'img_dir_name':'jpg/','split_file':'oxfordflowers_split_dict.json','split_names':['train','val','test']},
            'oxford_flowers':{'img_dir_name':'jpg/','split_file':'old_split_zhou_OxfordFlowers.json','split_names':['train','val','test']},
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', choices=['ucf101','food101','sun397','stanford_cars','fgvc-aircraft','caltech-101','stanford_cars',
                                                'eurosat','resisc45','aid','patternnet','ucm','whurs19','mlrsnet','optimal31',
                                                'oxford_pets','oxford_flowers','dtd', 'sun397', 'cifar10', 'cifar100','fgvc_aircraft',
