...
#         label_to_category = json.load(open('data/oxford_flowers/cat_to_name.json'))
#         label_to_category = {value: key for key, value in label_to_category.items()}
...
#                 if len(sub_label_df) == 0:
#                     raise NotImplementedError
#             # pseudo_full = pd.concat((pseudo_full, sub_label_df))
...
#     if args['dataset'] not in ['caltech-101','oxford_flowers']:
...
#                                                                 'eurosat', 'stanford_cars','fgvc_aircraft',
