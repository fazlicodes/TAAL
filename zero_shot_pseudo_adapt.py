...
dataset_to_template = {'cct20':'a photo of a {}.',
                    ...
                    #   'resisc45':'a centered satellite photo of {}.',
                    #   'optimal31':'a centered satellite photo of {}.',
                    #   'aid':'a centered satellite photo of {}.',
                    #   'patternnet':'a centered satellite photo of {}.',
                    
                      'eurosat':'a satellite photo of {}.',
                      'resisc45':'a satellite photo of {}.',
                      'aid':'a satellite photo of {}.',
                      'patternnet':'a satellite photo of {}',
                      'ucm':'a satellite photo of {}.',
...
def main(args):    
    ...
    if "GeoRSCLIP" in args['pretrained_model']:
        pretrained_feature_folder = 'clip_georsclip_feat'
        pretrained_model = 'clip_georsclip'
    else:
    ...
    with open(os.path.join(report_dir, 'zero_shot_results'), 'a+') as writer:
